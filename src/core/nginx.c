...
main(int argc, char *const *argv)
{
    ...
    printf("nginx::ngx_debug_init\n");
    ngx_debug_init();

    printf("nginx::ngx_strerror_init\n");
    if (ngx_strerror_init() != NGX_OK)
    {
        return 1;
    }

    printf("nginx::ngx_get_options\n");
    if (ngx_get_options(argc, argv) != NGX_OK)
    {
        return 1;
    }

    printf("nginx::ngx_show_version\n");
    if (ngx_show_version)
    {
    ...
    printf("nginx::ngx_time_init\n");
    ngx_time_init();

#if (NGX_PCRE)
    printf("nginx::ngx_regex_init\n");
    ngx_regex_init();
#endif

    printf("nginx::ngx_getpid\n");
    ngx_pid = ngx_getpid();
    printf("nginx::ngx_getppid\n");
    ngx_parent = ngx_getppid();

    printf("nginx::ngx_log_init\n");
    ...
    printf("nginx::ngx_memzero\n");
    ngx_memzero(&init_cycle, sizeof(ngx_cycle_t));
    init_cycle.log = log;
    ngx_cycle = &init_cycle;

    printf("nginx::ngx_create_pool\n");
    ...
    printf("nginx::ngx_save_argv\n");
    if (ngx_save_argv(&init_cycle, argc, argv) != NGX_OK)
    {
        return 1;
    }

    printf("nginx::ngx_process_options\n");
    if (ngx_process_options(&init_cycle) != NGX_OK)
    {
        return 1;
    }

    printf("nginx::ngx_os_init\n");
    ...
    printf("nginx::ngx_crc32_table_init\n");
    ...
    printf("nginx::ngx_slab_sizes_init\n");
    ngx_slab_sizes_init();
    ...
    printf("nginx::ngx_preinit_modules\n");
    if (ngx_preinit_modules() != NGX_OK)
    {
        return 1;
    }

    printf("nginx::ngx_init_cycle\n");
    ...
    printf("nginx::ngx_signal\n");
    if (ngx_signal)
    {
        return ngx_signal_process(cycle, ngx_signal);
    }

    printf("nginx::ngx_os_status\n");
    ngx_os_status(cycle->log);

    ngx_cycle = cycle;

    printf("nginx::ngx_get_conf\n");
    ...
    printf("nginx::ngx_create_pidfile\n");
    if (ngx_create_pidfile(&ccf->pid, cycle->log) != NGX_OK)
    {
        return 1;
    }

    printf("nginx::ngx_log_redirect_stderr\n");
    ...
    {
        printf("nginx::ngx_single_process_cycle\n");
        ngx_single_process_cycle(cycle);
    }
    else
    {
        printf("nginx::ngx_master_process_cycle\n");
        ngx_master_process_cycle(cycle);
    }
    printf("nginx::main::end\n");
