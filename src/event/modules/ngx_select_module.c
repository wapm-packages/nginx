                          ...
                          ngx_uint_t flags)
{
    ...
    ngx_connection_t *c;
    printf("nginx::ngx_select_process_events\n");
    ...
    printf("nginx::ngx_select_process_events::select \n");
    ready = select(max_fd + 1, &work_read_fd_set, &work_write_fd_set, NULL, tp);

    printf("nginx::ngx_select_process_events::select->(%d)\n", ready);
    ...
    printf("nginx::ngx_select_process_events (%d, %d)\n", err, ready);
    ...
    for (i = 0; i < nevents; i++)
    {
        ...
        printf("nginx::ngx_select_process_events::nevents (%lu)\n", i);
        ...
        printf("nginx::ngx_select_process_events::nevents->found %lu\n", found);
        ...
        if (found)
        {
            ...
            printf("nginx::ngx_select_process_events::ngx_post_event %lu\n", found);
