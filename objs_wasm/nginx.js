...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'nginx.wast';
  var wasmBinaryFile = 'nginx.wasm';
  var asmjsCodeFile = 'nginx.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  err('missing function: getgrnam'); abort(-1);
  }
  ...
  err('missing function: sigsuspend'); abort(-1);
  }
...
Module['wasmTableSize'] = 8192;

Module['wasmMaxTableSize'] = 8192;
